...
-- get the customer first_name, last_name, email from the customer table
-- use customer.address_id to join with address.address_id
-- address.address_id -> address.city_id
-- city.city_id -> city.country_id
-- country.country_id -> country.country = "Canada"
...
-- count the number of "rental ids". find the max of those and display the film title
...
-- SUM(payment.amount) group by store.store_id
